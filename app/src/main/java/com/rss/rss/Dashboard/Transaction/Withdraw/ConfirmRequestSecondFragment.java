...
public class ConfirmRequestSecondFragment extends Fragment {

    private static final String TAG = "ConfirmRequestSecondFra";

    //Widget
    private Button btnNext;

    public ConfirmRequestSecondFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_confirm_request_second, container, false);
    ...
    private void initWidget(View view) {
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                pushFragment(new ConfirmRequestThirdFragment());
            }
        });
    }
