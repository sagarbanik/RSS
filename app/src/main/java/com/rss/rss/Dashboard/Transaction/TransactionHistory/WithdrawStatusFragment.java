package com.rss.rss.Dashboard.Transaction.TransactionHistory;
...
public class WithdrawStatusFragment extends Fragment {
    ...
    private static final String TAG = "WithdrawStatusFragment";
    ...
    private void initToolbar(){
        ...
        toolbar.setTitle("Transaction|Withdraw Status");
